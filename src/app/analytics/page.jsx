  ...
  const summaryCards = [
    {
      ...
      iconShellClassName: 'bg-[#f1d6d6] dark:bg-red-950/40',
      iconClassName: 'text-[#991b1b] dark:text-red-300',
      icon: (
    ...
    },
    {
      ...
      valueClassName: 'text-[#991b1b] dark:text-red-300',
      iconShellClassName: 'bg-[#f1d6d6] dark:bg-red-950/40',
      iconClassName: 'text-[#991b1b] dark:text-red-300',
      icon: (
    ...
    },
    {
      ...
      valueClassName: 'text-[#9a3412] dark:text-orange-300',
      iconShellClassName: 'bg-[#f6dcc7] dark:bg-orange-950/40',
      iconClassName: 'text-[#9a3412] dark:text-orange-300',
      icon: (
    ...
    },
    {
      ...
      valueClassName: 'text-[#1e40af] dark:text-blue-300',
      iconShellClassName: 'bg-[#d7e4fb] dark:bg-blue-950/40',
      iconClassName: 'text-[#1e40af] dark:text-blue-300',
      icon: (
            ...
            <div key={card.title} className="theme-surface rounded-3xl p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className={`mt-2 text-4xl font-extrabold tracking-tight ${card.valueClassName}`}>
                    {card.value}
                  </p>
                </div>
              ...
              <div className="space-y-3">
                {analytics.topIPs.map(([ip, count], index) => (
                  <div key={ip} className="theme-inset-surface flex items-center justify-between rounded-xl p-3">
                    ...
                    <span className="rounded-full bg-[#ffe4e6] px-3 py-1 text-sm font-bold text-[#9f1239] ring-1 ring-[#fda4af] dark:bg-red-950/30 dark:text-red-300 dark:ring-red-900/60">
                      {count} attacks
                    </span>
                  </div>
                ))}
