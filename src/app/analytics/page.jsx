  ...
  const summaryCards = [
    {
      ...
      iconShellClassName: 'bg-red-200/90 dark:bg-red-950/40',
    ...
    },
    {
      ...
      iconShellClassName: 'bg-orange-200/90 dark:bg-orange-950/40',
    ...
    },
    {
      ...
      iconShellClassName: 'bg-blue-200/90 dark:bg-blue-950/40',
              ...
              <div className="space-y-3">
                {analytics.topIPs.map(([ip, count], index) => (
                  <div key={ip} className="theme-inset-surface flex items-center justify-between rounded-xl p-3">
                    ...
                    <span className="text-sm font-semibold text-red-700 dark:text-red-300">{count} attacks</span>
                  </div>
                ))}
              </div>
            ) : (
